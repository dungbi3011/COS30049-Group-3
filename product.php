                ...
                <div class="col-sm-4 d-flex">
                    <div class="card mt-5 mb-5 Maincourse">
                        ...
                        <div class="card-footer">
                            <a href = "wallet.php" class="btn btn-primary">Buy with 2</a>
                        </div>
                    </div>
                </div>
                <div class="col-sm-4 d-flex">
                    <div class="card mt-5 mb-5 Maincourse">
                        ...
                        <div class="card-footer">
                            <a href = "wallet.php" class="btn btn-primary">Buy with 1.23</a>
                        </div>
                    </div>
                </div>
                <div class="col-sm-4 d-flex">
                    <div class="card mt-5 mb-5 Maincourse">
                        ...
                        <div class="card-footer">
                            <a href = "wallet.php" class="btn btn-primary">Buy with 2.2</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-4 d-flex">
                    <div class="card mb-5 Maincourse">
                        ...
                        <div class="card-footer">
                            <a href = "wallet.php" class="btn btn-primary">Buy with 0.5</a>
                        </div>
                    </div>
                </div>
                <div class="col-sm-4 d-flex">
                    <div class="card mb-5 Maincourse">
                        ...
                        <div class="card-footer">
                            <a href = "wallet.php" class="btn btn-primary">Buy with 0.42</a>
                        </div>
                    </div>
                </div>
                <div class="col-sm-4 d-flex">
                    <div class="card mb-5 Dessert">
                        ...
                        <div class="card-footer">
                            <a href = "wallet.php" class="btn btn-primary">Buy with 0.98</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-4 d-flex">
                    <div class="card mb-5 Appetizer">
                        ...
                        <div class="card-footer">
                            <a href = "wallet.php" class="btn btn-primary">Buy with 0.19</a>
                        </div>
                    </div>
                </div>
                <div class="col-sm-4 d-flex">
                    <div class="card mb-5 Appetizer">
                        ...
                        <div class="card-footer">
                            <a href = "wallet.php" class="btn btn-primary">Buy with 0.53</a>
                        </div>
                    </div>
                </div>
                <div class="col-sm-4 d-flex">
                    <div class="card mb-5 Dessert">
                        ...
                        <div class="card-footer">
                            <a href = "wallet.php" class="btn btn-primary">Buy with 0.68</a>
                        </div>
                    </div>
                </div>
            </div>
