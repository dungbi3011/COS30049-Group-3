...
<html lang="en">
  ...
  <body>
    <header class="header">
      ...
      <nav class="nav">
        <ul class="nav-list">
          <li><a href="./home.html" class="nav-link"><img class = "nav_home_img" alt = "" src = "images/home_symbol.png">&emsp;Home</a></li>
          <li><a href="./product.html" class="nav-link"><img class = "nav_cooking_img" alt = "" src = "images/cooking.png">&emsp;Recipes</a></li>
          <li><a href="./transaction.html" class="nav-link"><img class = "nav_transaction_img" alt = "" src = "images/transaction_symbol.png">&emsp;Transaction</a></li>
          <li><a href="./login.html" class="nav-link"><img class = "nav_cart_img" alt = "" src = "images/cart_symbol.png">&emsp;Cart</a></li>
          <li><a href="./wallet.html" class="nav-link nav-cta"><img class = "nav_wallet_img" alt = "" src = "images/wallet.png">&emsp;Connect Wallet</a></li>
        </ul>
      </nav>
    </header>
    ...
    <main>
          ...
          <ul class="promo-list has-scrollbar">
            ...
            <li class="promo-item">
              <div class="promo-card">
                ...
                <img src="images/promo-1.png" width="300" height="300" loading="lazy" alt="Maxican Pizza"
            ...
            <li class="promo-item">
              <div class="promo-card">
                ...
                <img src="images/promo-4.png" width="300" height="300" loading="lazy" alt="Burger Kingo"
                  class="w-100 card-banner">
            ...
            <li class="promo-item">
              <div class="promo-card">
                ...
                <img src="images/promo-5.png" width="300" height="300" loading="lazy" alt="Chicken Masala"
                  class="w-100 card-banner">
          ...
          <ul class="food-menu-list">
            ...
            <li>
              <div class="food-menu-card">
                ...
                <div class="card-banner">
                  <img src="images/food-menu-1.png" width="300" height="300" loading="lazy"
            ...
            <li>
              <div class="food-menu-card">
                ...
                <div class="card-banner">
                  <img src="images/food-menu-2.png" width="300" height="300" loading="lazy"
            ...
            <li>
              <div class="food-menu-card">
                ...
                <div class="card-banner">
                  <img src="images/food-menu-3.png" width="300" height="300" loading="lazy"
            ...
            <li>
              <div class="food-menu-card">
                ...
                <div class="card-banner">
                  <img src="images/food-menu-4.png" width="300" height="300" loading="lazy"
            ...
            <li>
              <div class="food-menu-card">
                ...
                <div class="card-banner">
                  <img src="images/food-menu-5.png" width="300" height="300" loading="lazy"
      ...
      <section class="section section-divider white testi">
        <div class="container">
          ...
          <h2 class="h2 section-title">
            Our Contact <span class="span">Reviews</span>
          </h2>
          ...
          <ul class="banner-list">
            ...
            <li class="banner-item banner-lg">
              <div class="banner-card">
                ...
                <img src="images/banner-1.jpg" width="550" height="450" loading="lazy"
            ...
            <li class="banner-item banner-sm">
              <div class="banner-card">
                ...
                <img src="images/banner-2.jpg" width="550" height="465" loading="lazy" alt="Delicious Pizza"
                  class="banner-img">
            ...
            <li class="banner-item banner-sm">
              <div class="banner-card">
                ...
                <img src="images/banner-3.jpg" width="550" height="465" loading="lazy" alt="American Burgers"
                  class="banner-img">
            ...
            <li class="banner-item banner-md">
              <div class="banner-card">
                ...
                <img src="images/banner-4.jpg" width="550" height="220" loading="lazy" alt="Tasty Buzzed Pizza"
                  class="banner-img">
    ...
    <footer>
        <div id="footer1">
            <div id="nav_footer">
                ...
                <div id="explore_footer">
                    <p><a href="./home.html"><i class="fa-sharp fa-solid fa-angle-right"></i>Home</a></p>
                    <p><a href="./product.html"><i class="fa-sharp fa-solid fa-angle-right"></i>Product</a></p>
                    <p><a href="./transaction.html"><i class="fa-sharp fa-solid fa-angle-right"></i>Transaction</a></p>
                    <p><a href="./login.html"><i class="fa-sharp fa-solid fa-angle-right"></i>Cart</a></p>
                    <p><a href="./wallet.html"><i class="fa-sharp fa-solid fa-angle-right"></i>Connect Wallet</a></p>
                </div>
            </div>
            <div id="overall">
                <h2><span>ABOUT</span></h2>
                <p><a href="./home.html">The Company</a></p>
                <p><a href="#">FAQ</a></p>
        ...
        <div id="footer2">
            <p><i class="fa-solid fa-copyright"></i>2023 Foodie. ALL RIGHTS RESERVED.</p>
